...
const FunInitShareBtn = (t_Color) => {
    ...
    //分享至QQ
     $('.js-jumpurl-qq-cardId').click(function () {
         var ShareUrl = 'https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=' + NowSharePageUrl + $('#dialog-share').val() + '&sharesource=qzone&title=' + encodeURI(NowPageShareData['title'] + '&summary=' + NowPageShareData['content'] + '\n来自' + $('title').text());
         window.open(ShareUrl, '_blank');
     });
     //分享至WeChat
